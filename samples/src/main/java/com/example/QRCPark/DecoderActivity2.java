        ...
        public class DecoderActivity2 extends AppCompatActivity
      ...
      View.OnClickListener handler = new View.OnClickListener(){
        public void onClick(View v) {
          ...
          switch (v.getId()) {
            ...
            case R.id.button4:
              // doStuff
              startActivity(new Intent(DecoderActivity2.this, Map4.class));
              break;
          }
        }
      };
  ...
  @Override public void onQRCodeRead(String text, PointF[] points) {
    resultTextView.setText("Car Detected");
    ...
    if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.CAMERA)) {
      Snackbar.make(mainLayout, "Camera access is required to display the camera preview.",
        ...
        @Override public void onClick(View view) {
          ActivityCompat.requestPermissions(DecoderActivity2.this, new String[] {
